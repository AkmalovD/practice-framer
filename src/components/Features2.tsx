...
import { ReceiptText, CircleDollarSign, TrendingUpDown, Blocks } from "lucide-react"

const features = [
    { label: 'Invoicing', icon: ReceiptText },
    { label: 'Budgets', icon: CircleDollarSign },
    { label: 'Forecasting', icon: TrendingUpDown },
                ...
                <div className="max-w-6xl mx-auto flex flex-col lg:flex-row items-stretch gap-12 lg:gap-20">
                    ...
                    >   
                        ...
                        <p className="mt-5 text-base md:text-lg text-gray-600 leading-relaxed max-w-xl">
                            <strong>Create branded invoices,</strong>log expenses, and keep tabs on your earnings. Whether you bill hourly or per project, everything’s automated and tax-friendly.
                        </p>
                        ...
                        <div className="mt-36 grid grid-cols-2 gap-3 justify-center lg:justify-start">
